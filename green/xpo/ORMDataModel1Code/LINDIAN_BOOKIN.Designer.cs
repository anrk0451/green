...
namespace green.xpo.orcl
{
    ...
    [Persistent(@"LINDIAN.BOOKIN")]
    public partial class LINDIAN_BOOKIN : XPLiteObject
    {
        string fREGISTER_ID;
        [Indexed(Name = @"IDX_BOOKIN_REGISTER_ID")]
        [Size(20)]
