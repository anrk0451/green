    ...
    class SalesItem_ds:System.Data.DataSet
    {
        ...
        public SalesItem_ds()
        {
			...
			Si01.Columns.AddRange(new DataColumn[]
				{col_si001,col_si003,col_price,col_si088,col_si_sortId,col_si099,col_si_status,col_si066,col_si055});
			...
			Gi01.Columns.AddRange(new DataColumn[]
				{col_gi001,col_gi003,col_price2,col_gi088,col_gi_sortId,col_gi099,col_gi_status,col_gi066,col_gi055});
